...
%     \end{frame}
    ...
    \newcommand{\colorStepOne}{orange}
    \newcommand{\colorStepTwo}{yellow}
    \newcommand{\colorStepThree}{green}
    \newcommand{\colorStepFour}{cyan}
    \newcommand{\colorStepFive}{magenta}
    % BEGIN Uebersicht
    ...
    \onslide<1-5>{
         ...
         \begin{tikzpicture}
         \only<1>{
        \node[rectangle,draw,text=black, fill=\colorStepOne, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r1) at (0,0) {Hintergrundrauschen\\ verringern};
        \node[rectangle,draw,text=black, fill=\colorStepTwo, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r3) at (0,-3.5) {Entfernung irrelevanter\\ Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r4) at (0,-5.25) {Normierung auf +1\\Ladung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r5) at (0,-7) {Zusammenfassen};
          }%
          \only<2>{
          \node[rectangle,draw,text=black, fill=\colorStepOne, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r1) at (0,0) {Hintergrundrauschen\\ verringern};
        \node[rectangle,draw,text=black, fill=\colorStepTwo, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r3) at (0,-3.5) {Entfernung irrelevanter\\ Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r4) at (0,-5.25) {Normierung auf +1\\Ladung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r5) at (0,-7) {Zusammenfassen};
        ...
        \node[rectangle,draw,text=black, fill=\colorStepOne, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r1) at (0,0) {Hintergrundrauschen\\ verringern};
        \node[rectangle,draw,text=black, fill=\colorStepTwo, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r3) at (0,-3.5) {Entfernung irrelevanter\\ Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r4) at (0,-5.25) {Normierung auf +1\\Ladung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r5) at (0,-7) {Zusammenfassen};
          \draw[->, ultra thick, opacity=1] (r1) -- (r2);
        ...
        \node[rectangle,draw,text=black, fill=\colorStepTwo, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r3) at (0,-3.5) {Entfernung irrelevanter\\ Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r4) at (0,-5.25) {Normierung auf +1\\Ladung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r5) at (0,-7) {Zusammenfassen};
          \draw[->, ultra thick, opacity=1] (r1) -- (r2);
          \draw[->, ultra thick, opacity=1] (r2) -- (r3);
        ...
        \node[rectangle,draw,text=black, fill=\colorStepTwo, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r3) at (0,-3.5) {Entfernung irrelevanter\\ Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r4) at (0,-5.25) {Normierung auf +1\\Ladung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r5) at (0,-7) {Zusammenfassen};
          \draw[->, ultra thick, opacity=1] (r1) -- (r2);
          \draw[->, ultra thick, opacity=1] (r2) -- (r3);
          \draw[->, ultra thick, opacity=1] (r3) -- (r4);
    ...
    \begin{minipage}[c]{0.2\textwidth}
      \centering
        \begin{tikzpicture}[font=\tiny]
            ...
            \node[rectangle,draw,text=black, fill=\colorStepOne,opacity=\currElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r1) at (\xStartOverview,\yStartOverview) {Hintergrundrauschen};
            \node[rectangle,draw,text=black, fill=\colorStepTwo,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
            \node[rectangle,draw,text=black, fill=\colorStepThree, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r3) at (\xStartOverview,\yStartOverview-1.5) {Irrelevante Peaks};
            \node[rectangle,draw,text=black, fill=\colorStepFour, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {$+1$ Normierung};
            \node[rectangle,draw,text=black, fill=\colorStepFive, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r5) at (\xStartOverview,\yStartOverview-3) {Zusammenfassen};
...
\begin{frame}{pNovo+ Algorithmus \dashAndSpace Datenaufbereitung}
    ...
    \item<6-> \gerquot{Charge state} Zuweisung:
    \begin{itemize}
     \item<6-> \textcolor{\colorMonoisotopicMassPeak}{Monoisotopischer Peak}: $+1$
     \item<6-> \textcolor{\colorPeakWithChargeDistance}{Abstand}: steigend mit $+1$
    \end{itemize}
    \end{itemize}
    \end{minipage}
}%
\onslide<1->{
  ...
  \centering
     \begin{tikzpicture}[font=\tiny]
         %\node[rectangle] at (0,0) {};
        \node[rectangle,draw,text=black, fill=\colorStepOne,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r1) at (\xStartOverview,\yStartOverview) {Hintergrundrauschen};
        \node[rectangle,draw,text=black, fill=\colorStepTwo,opacity=\currElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r3) at (\xStartOverview,\yStartOverview-1.5) {Irrelevante Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {$+1$ Normierung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r5) at (\xStartOverview,\yStartOverview-3) {Zusammenfassen};
          \draw[->, ultra thick] (r1) -- (r2);
...
\begin{frame}{pNovo+ Algorithmus \dashAndSpace Datenaufbereitung}
    ...
    \item<1-> $m/z$ Bereiche, die garantiert nicht stimmen können
    \end{itemize}
    \end{minipage}
}
\onslide<1->{
  ...
  \centering
     \begin{tikzpicture}[font=\tiny]
        ...
        \node[rectangle,draw,text=black, fill=\colorStepOne,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r1) at (\xStartOverview,\yStartOverview) {Hintergrundrauschen};
        \node[rectangle,draw,text=black, fill=\colorStepTwo,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, opacity=\currElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r3) at (\xStartOverview,\yStartOverview-1.5) {Irrelevante Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {$+1$ Normierung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r5) at (\xStartOverview,\yStartOverview-3) {Zusammenfassen};
          \draw[->, ultra thick] (r1) -- (r2);
          \draw[->, ultra thick] (r2) -- (r3);
...
\fill[red!25!,opacity=.25] (0,0) rectangle (1,\yAxisHeight-\axisColorOffset);
  ...
  \centering
     \begin{tikzpicture}[font=\tiny]
        ...
        \node[rectangle,draw,text=black, fill=\colorStepTwo,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r3) at (\xStartOverview,\yStartOverview-1.5) {Irrelevante Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, opacity=\currElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {$+1$ Normierung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r5) at (\xStartOverview,\yStartOverview-3) {Zusammenfassen};
          \draw[->, ultra thick] (r1) -- (r2);
          \draw[->, ultra thick] (r2) -- (r3);
          \draw[->, ultra thick] (r3) -- (r4);
  ...
  \centering
     \begin{tikzpicture}[font=\tiny]
        ...
        \node[rectangle,draw,text=black, fill=\colorStepTwo,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepThree, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r3) at (\xStartOverview,\yStartOverview-1.5) {Irrelevante Peaks};
          \node[rectangle,draw,text=black, fill=\colorStepFour, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {$+1$ Normierung};
          \node[rectangle,draw,text=black, fill=\colorStepFive, opacity=\currElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r5) at (\xStartOverview,\yStartOverview-3) {Zusammenfassen};
          \draw[->, ultra thick] (r1) -- (r2);
          \draw[->, ultra thick] (r2) -- (r3);
          \draw[->, ultra thick] (r3) -- (r4);
          \draw[->, ultra thick] (r4) -- (r5);
