...
\begin{document}
  ...
  \LaTeX, Bib\TeX/ biber, make\-index, \LaTeX}
   ...
   \end{frame}
    ...
    \begin{frame}{pNovo+ Algorithmus \dashAndSpace Verarbeitungsschritte}
    \begin{itemize}
     \item<1-> Datenaufbereitung
     \begin{itemize}
      \item<2-> Hintergrundrauschen verringern
      \item<3-> Entfernen von falschen Peaks
      \item<4-> Entfernen von irrelevanten Peaks
      \item<5-> Zusammenfasen von Peaks
     \end{itemize}
    \item<6-> Bildung eines Spektrums-Graphen
    \item<7-> Identifikation der AS-Sequenz
     \end{itemize}
    \end{frame}
