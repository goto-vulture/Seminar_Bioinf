...
%             }
    ...
    ylabel={$f(x)=\numAA^x$}]
        ...
        \onslide<2->{
         ...
         \draw[green] (149.04489, 15549.466) -- (135.04489, 16549.466);

         \node (1) at (167.05548, 30403.949) [above] {\tiny 167.05};
         \node (2) at (213.81911, 13479.453) [above] {\tiny 213.81};
         \node (3) at (341.01804, 28799.889) [above] {\tiny 341.01};

         %\node (4) at (359.02826, 24235.844) [above] {\tiny 359.02};
         \node (4) at (375.02826, 24635.844) [above] {\tiny 359.02};
         \draw[green] (359.02826, 24235.844) -- (375.02826, 25235.844);

         %\node (5) at (404.45569, 5915.098) [above] {\tiny 404.45};
         \node (5) at (395.45569, 5915.098) [above] {\tiny 404.45};
         \draw[green] (404.45569, 5915.098) -- (395.45569, 6615.098);

         \node (6) at (429.08765, 59781.848) [above] {\tiny 429.08};
         \node (7) at (486.75085, 6172.900) [above] {\tiny 486.75};
         \node (8) at (603.03772, 5612.658) [above] {\tiny 603.03};

         \draw [<->,thick] (0,60000) node (yaxis) [above] {\small Rel. abundance}
...
\draw[thick] (603.03772, 0.0) -- (603.03772, 5612.658);
   \end{tikzpicture}%
         ...
         \begin{itemize}
          \item<3-> Vereinfachte Darstellung von realen Messwerten
         \end{itemize}
        \end{frame}
