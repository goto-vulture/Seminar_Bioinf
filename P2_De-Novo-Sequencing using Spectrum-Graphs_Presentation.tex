...
\fill[red!25!,opacity=.25] (0,0) rectangle (1,\yAxisHeight-\axisColorOffset);
   ...
   \end{minipage}%
    ...
    \centering
    \begin{itemize}
    \item<1-> Peaks auf Charge state $+1$ normieren
    \item<2-> $\Rightarrow$ Verschiebung nach rechts auf $m/z$ Achse
    \end{itemize}
    \end{minipage}
    }
    \onslide<1->{
...
\draw [<->,thick] (0,\yAxisHeight) node (yaxis) [above] {\yAxisUnit} |- (\xAxisLength,0) node (xaxis) [right] {\xAxisUnit};
   ...
   \end{minipage}%
    ...
    \newcommand{\mergeColorTwo}{olive}
    \newcommand{\mergeColorThree}{green}
...
\draw [<->,thick] (0,\yAxisHeight) node (yaxis) [above] {\yAxisUnit} |- (\xAxisLength,0) node (xaxis) [right] {\xAxisUnit};
  ...
  \end{minipage}
    ...
    \begin{itemize}
     ...
     \item<2-> Peaks $\widehat{=}$ Knotenpaar
