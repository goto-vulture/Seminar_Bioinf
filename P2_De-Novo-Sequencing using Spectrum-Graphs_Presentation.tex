...
\begin{document}
    ...
    \section{Aminosäure Sequenzierung}
        ...
        \begin{frame}{AA Sequenzierung \dashAndSpace Relevanz}
        \begin{itemize}
        \item<1-> Biomedizinisch relevant:
        \begin{itemize}
         \item<1-> Katalogisierung von Proteinen
         \item<1-> Wechselwirkungen von Proteinen
...
%             }
        ...
        \begin{frame}{Anzahl an Kombinationen}
         \onslide<1->{
         \begin{itemize}
          \item<1-> Bereits bei wenigen AS: Kaum händelbare Anzahl an Kombinationen
         \end{itemize}
         }%
         \onslide<2->{
         \centering
    ...
    ylabel={$f(x)=20^x$}]
        ...
        \onslide<1->{
         ...
         \begin{tikzpicture}[scale=0.02, x=0.550cm, y=0.0075cm, baseline=(current bounding box.center)]
         \draw [<->,thick] (0,30000) node (yaxis) [above] {\yAxisUnit}
         |- (625,0) node (xaxis) [right] {\xAxisUnit};
...
\draw[thick] (603.03772, 0.0) -- (603.03772, 5612.658);
   ...
   \end{frame}
    ...
    \newcommand{\minHeightOverview}{0.4cm}
    ...
    \only<1>{
        ...
        \node[rectangle,draw,text=black, fill=yellow, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          ...
          \node[rectangle,draw,text=black, fill=magenta, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=0] (r4) at (0,-5.25) {Zusammenfassen};
        ...
        \node[rectangle,draw,text=black, fill=yellow, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r2) at (0,-1.75) {Entfernung falscher\\Peaks};
          \node[rectangle,draw,text=black, fill=green, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r3) at (0,-3.5) {Entfernung irrelevanter\\ Peaks};
          \node[rectangle,draw,text=black, fill=magenta, minimum width=\minWidth, minimum height=\minHeight, align=center, opacity=1] (r4) at (0,-5.25) {Zusammenfassen};
          \draw[->, ultra thick, opacity=1] (r1) -- (r2);
          \draw[->, ultra thick, opacity=1] (r2) -- (r3);
  ...
  \centering
     \begin{tikzpicture}[font=\tiny]
        ...
        \node[rectangle,draw,text=black, fill=yellow,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
          ...
          \node[rectangle,draw,text=black, fill=magenta, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {Zusammenfassen};
...
\onslide<1->{
  ...
  \centering
     \begin{tikzpicture}[font=\tiny]
        ...
        \node[rectangle,draw,text=black, fill=yellow,opacity=\otherElementOpacity, minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r2) at (\xStartOverview,\yStartOverview-0.75) {Falsche Peaks};
          \node[rectangle,draw,text=black, fill=green, opacity=\otherElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r3) at (\xStartOverview,\yStartOverview-1.5) {Irrelevante Peaks};
          \node[rectangle,draw,text=black, fill=magenta, opacity=\currElementOpacity,minimum width=\minWidthOverview, minimum height=\minHeightOverview, align=center] (r4) at (\xStartOverview,\yStartOverview-2.25) {Zusammenfassen};
          \draw[->, ultra thick] (r1) -- (r2);
          \draw[->, ultra thick] (r2) -- (r3);
          \draw[->, ultra thick] (r3) -- (r4);
         \end{tikzpicture}
